    ...
    try {
        ...
        if (error) {
            ...
            const createQuestions = async() => {
                const newPrompt = 'Please analyze the provided text and create multiple (no more than 5) exam-style questions that are each worth 4 marks, suitable for the UK Education System (A Levels / GCSE). The questions should be concise, with the mark scheme criteria narrow in scope and targeted to specific pieces of information or basic concepts covered in the text. Each question should have a mark scheme rubric with 4 criteria, each corresponding to 1, 2, 3, and 4 marks, progressively increasing in specificity or difficulty, with the 4-mark criterion representing the requirements for full marks. Generate a JSON object with the following structure: { "questions": [ { "question": "(Concise 4-mark question)", "markScheme": { "totalMarks": 4, "rubric": [ { "marks": 1, "criteria": "(Criterion to achieve 1 mark out of 4)" }, { "marks": 2, "criteria": "(Criterion to achieve 2 marks out of 4)" }, { "marks": 3, "criteria": "(Criterion to achieve 3 marks out of 4)" }, { "marks": 4, "criteria": "(Criterion to achieve 4 marks out of 4, i.e., full marks)" } ] } } ] }. The questions you give must be appropriate for a 4 marker question that would come up in an exam for that topic, and your marking scheme must be precise, remember to return your response in a JSON Object.'
